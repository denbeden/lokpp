...
### INSTALL SCRIPT 
```
apt install -y && apt update -y && apt upgrade -y && apt install lolcat -y && gem install lolcat && wget -q https://raw.githubusercontent.com/denbeden/lokpp/master/premi.sh && chmod +x premi.sh && ./premi.sh
...
wget https://raw.githubusercontent.com/denbeden/lokpp/master/update.sh && chmod +x update.sh && ./update.sh
